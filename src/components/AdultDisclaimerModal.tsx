...
export function AdultDisclaimerModal({ isOpen, onClose, onAccept, serviceName }: AdultDisclaimerModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-md panel-3d border-2 border-[hsl(25,100%,55%)]/50">
        <DialogHeader>
