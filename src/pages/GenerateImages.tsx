        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              <span className="text-[hsl(var(--primary))] font-bold">{filteredModels.length}</span> modèles • <span className="text-[hsl(142,76%,50%)]">{freeModelsCount} gratuits</span>
            </p>
          </div>
        </div>
          ...
          >
            {uploadedImage ? (
              ...
              <div className="flex flex-col items-center gap-3 text-center">
                ...
                <div>
                  <p className="font-display text-lg text-foreground">Glissez une image ici (optionnel)</p>
                  <p className="text-sm text-muted-foreground">ou cliquez pour sélectionner (Image-to-Image)</p>
                </div>
              </div>
            )}
            <input
