      ...
      <main className="ml-40 min-h-screen">
        <div className="container mx-auto max-w-7xl px-4 py-8">
          ...
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-2">
              <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[hsl(174,100%,50%)]/20">
                <Wand2 className="h-5 w-5 text-[hsl(174,100%,50%)]" />
              </div>
              <div>
                <h1 className="font-display text-2xl font-bold gradient-text-cyan">
                  Retouche & Édition d'Images
                </h1>
                <p className="text-sm text-muted-foreground">
                  Retouchez et améliorez vos images avec l'IA • <span className="text-[hsl(var(--primary))]">{models.length} modèles</span> disponibles
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
            ...
            <div className="space-y-4">
              ...
              <PromptEditor
                ...
                placeholder="Ex: Supprime l'arrière-plan et améliore la qualité de l'image, augmente la résolution x4"
              />
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="font-display text-xl font-semibold">Tous les modèles de retouche</h2>
