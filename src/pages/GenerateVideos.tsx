...
import { Video, Sparkles, Camera, Film, Type, Upload } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="ml-[200px] min-h-screen p-6">
        ...
        {/* Main Generation Interface - Full Width */}
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 mb-10">
          {/* Left: Canvas - Takes 2 columns */}
          <div className="xl:col-span-2 space-y-4">
            ...
            <div className="panel-3d p-6">
              ...
              <Textarea
                ...
                placeholder="Décrivez l'image que vous souhaitez créer... Ex: Un château steampunk avec des engrenages dorés, 8K hyperréaliste"
              ...
              <div className="space-y-4">
                ...
                <div className="pt-4 border-t border-border/50 space-y-2">
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="font-bold text-foreground">1024x1024</span>
                  </div>
                  <div className="flex justify-between text-sm">
